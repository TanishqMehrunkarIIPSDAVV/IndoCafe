  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (userRole === 'KITCHEN') {
        ...
        setError('Invalid role. Kitchen staff login required.');
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="kitchen@indocafe.com"
                  value={email}
            ...
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white py-2 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
