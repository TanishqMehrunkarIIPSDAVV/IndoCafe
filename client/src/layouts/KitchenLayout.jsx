    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex flex-col flex-1">
        ...
        <header className="bg-surface border-b border-secondary/10 px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-primary">IndoCafe Kitchen</h1>
            <p className="text-xs text-secondary">Kitchen Operations</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-secondary/10">
              <div className="h-10 w-10 rounded-full bg-orange-600/20 text-orange-600 flex items-center justify-center text-sm font-bold">
                {user?.name?.charAt(0) || 'K'}
              </div>
              <div className="hidden sm:block">
                <p className="text-sm font-medium text-text">{user?.name}</p>
                <p className="text-xs text-secondary capitalize">Kitchen Staff</p>
              </div>
            </div>
